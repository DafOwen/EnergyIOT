...
public interface IDevices
{
    ...
    public Task AuthenticateRefreshToken(DeviceAuthConfig deviceAuthConfig);
    public Task<List<ActionFailure>> Plug(ActionGroup actionGroup, Action actionItem, string triggerName, RetryConfig retryConfig);
}
